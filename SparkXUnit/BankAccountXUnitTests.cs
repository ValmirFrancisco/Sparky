...
namespace Sparky
{
    public class BankAccountNUnitFacts
    {
        private BankAccount account;

        public BankAccountNUnitFacts()
        {
        ...
        public void BankLogDummy_LogMockStringOutputStr_ReturnTrue()
        {
            ...
            string result = "";
            Assert.True(logMock.Object.LogWithOutputResult("Asdrubal", out result));
        ...
        [Fact]
        public void BankLogDummy_SetAndGetLogTypeAndSeveirtyMock_MockFact()
        {
            var logMock = new Mock<ILogBook>();
            ...
            logMock.Object.LogToDb("Asdrubal");
            Assert.Equal("Hello, Asdrubal", logTemp);
